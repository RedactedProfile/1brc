///
/// Credit where Credit is due, this is a carbon copy of https://github.com/dannyvankooten/1brc/blob/main/create-sample.c 
/// But im on windows, and make is gross.  ~KH
/// 
